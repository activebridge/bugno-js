...
Bugno.prototype.errorHandler = function() {
  return function(err, request, response, next) {
    var cb = function(bugnoError) {
      if (bugnoError) {
        logger.error('Error reporting to bugno, ignoring: ' + bugnoError);
      }
...
Bugno.prototype.lambdaHandler = function(handler, timeoutHandler) {
  if (handler.length <= 2) {
...
Bugno.prototype.asyncLambdaHandler = function(handler, timeoutHandler) {
  var self = this;
...
Bugno.prototype.syncLambdaHandler = function(handler, timeoutHandler) {
  var self = this;
...
Bugno.lambdaHandler = function(handler) {
  if (_instance) {
...
Bugno.prototype.wrapCallback = function(f) {
  return wrapCallback(this, f);
};
Bugno.wrapCallback = function(f) {
  if (_instance) {
...
Bugno.prototype.reportMessage = function(message, level, request, callback) {
...
Bugno.reportMessage = function(message, level, request, callback) {
  if (_instance) {
...
Bugno.prototype.reportMessageWithPayloadData = function(message, payloadData, request, callback) {
  logger.log('reportMessageWithPayloadData is deprecated');
  return this.error(message, request, payloadData, callback);
};
Bugno.reportMessageWithPayloadData = function(message, payloadData, request, callback) {
  if (_instance) {
...
Bugno.prototype.handleError = function(err, request, callback) {
  logger.log('handleError is deprecated');
  return this.error(err, request, callback);
};
Bugno.handleError = function(err, request, callback) {
  if (_instance) {
...
Bugno.prototype.handleErrorWithPayloadData = function(err, payloadData, request, callback) {
  logger.log('handleErrorWithPayloadData is deprecated');
  return this.error(err, request, payloadData, callback);
};
Bugno.handleErrorWithPayloadData = function(err, payloadData, request, callback) {
  if (_instance) {
...
Bugno.handleUncaughtExceptions = function(accessToken, options) {
  if (_instance) {
    options = options || {};
    options.accessToken = accessToken;
...
Bugno.handleUnhandledRejections = function(accessToken, options) {
  if (_instance) {
    options = options || {};
    options.accessToken = accessToken;
    return _instance.configure(options);
...
Bugno.handleUncaughtExceptionsAndRejections = function(accessToken, options) {
  if (_instance) {
    options = options || {};
    options.accessToken = accessToken;
    return _instance.configure(options);
...
Bugno.prototype.handleUncaughtExceptions = function() {
  var exitOnUncaught = !!this.options.exitOnUncaughtException;
  delete this.options.exitOnUncaughtException;

  addOrReplaceBugnoHandler('uncaughtException', function(err) {
    if (!this.options.captureUncaught && !this.options.handleUncaughtExceptions) {
      return;
    }
...
Bugno.prototype.handleUnhandledRejections = function() {
  addOrReplaceBugnoHandler('unhandledRejection', function(reason) {
    if (!this.options.captureUnhandledRejections && !this.options.handleUnhandledRejections) {
      return;
    }
...
function BugnoError(message, nested) {
  Error.call(this);
...
util.inherits(BugnoError, Error);
Bugno.Error = BugnoError;
