function BugnoWrap(impl, options) {
  this.impl = impl(options, this);
  this.options = options;
  _setupForwarding(BugnoWrap.prototype);
}
...
BugnoWrap.prototype._swapAndProcessMessages = function(impl, messages) {
