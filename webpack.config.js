...
var snippetConfig = {
  name: 'snippet',
  entry: {
    'bugno.snippet': './src/browser/bundles/bugno.snippet.js'
  },
  output: {
    path: outputPath,
    filename: '[name].js'
...
var vanillaConfigBase = {
  entry: {
    'bugno': './src/browser/bundles/bugno.js'
  },
  output: {
    path: outputPath
  },
...
var UMDConfigBase = {
  entry: {
    'bugno.umd': ['./src/browser/bundles/bugno.js']
  },
  output: {
    path: outputPath,
    library: 'bugno',
...
noConflictConfigBase.entry = {
  'bugno.noconflict.umd': ['./src/browser/bundles/bugno.noconflict.js']
};

var namedAMDConfigBase = extend({}, UMDConfigBase);
namedAMDConfigBase.entry = {
  'bugno.named-amd': namedAMDConfigBase.entry['bugno.umd']
};
namedAMDConfigBase.output = extend({}, namedAMDConfigBase.output);
namedAMDConfigBase.output.library = 'bugno';
